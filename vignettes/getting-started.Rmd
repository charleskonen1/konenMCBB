...
- **Torvik year convention**: `year = 2025` = the 2024-25 season (ending year)
- **ESPN DB path**: set `options(konenMCBB.espn_db_path = ...)` in `~/.Rprofile`
- **Rate limiting**: use `sleep_sec = 0.3` in `espn_process_day()` for bulk collection
